...
@Entity
@Table(name = "manual_scenario_stock_weight")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@SuperBuilder
@SQLDelete(sql = "UPDATE manual_scenario_stock_weight SET deleted = 1, deleted_at = SYSDATETIMEOFFSET() WHERE id = ?")
public class ManualScenarioStockWeight extends SoftDeletableEntity {
