...
export default function UserDetailPanel({ user, currentUserEmail, onEditClick, onResendVerification, onChangePassword, onSendResetLink }: UserDetailPanelProps) {
  ...
  return (
    <div className="bg-white rounded-[18px] shadow-[0_2px_4px_rgba(18,22,31,0.04),0_12px_26px_-14px_rgba(18,22,31,0.12)] border border-[rgba(231,226,214,0.7)] px-5 py-[22px]">
      ...
      <div className="flex flex-col items-center text-center pb-[18px] mb-4 border-b border-admin-line">
        <div className="w-14 h-14 rounded-[15px] bg-gradient-to-br from-[#2A3247] to-admin-ink text-admin-gold-soft flex items-center justify-center font-heading font-bold text-xl mb-[11px] shadow-[0_8px_18px_-8px_rgba(18,22,31,0.35)]">
