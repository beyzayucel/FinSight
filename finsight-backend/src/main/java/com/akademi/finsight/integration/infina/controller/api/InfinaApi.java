...
public interface InfinaApi {
    ...
    @Operation(
            ...
            description = """
                Returns the fund's daily yield, total market value,
                and asset distribution.
                """
    )
    @ApiResponse(
            responseCode = "200",
            description = "Fund information retrieved successfully."
    )
    @ApiResponse(
            responseCode = "502",
            description = "Infina returned an error response."
    )
    @ApiResponse(
            responseCode = "503",
            description = "Infina service is currently unavailable.",
    ...
    @Operation(
            summary = "Get fund portfolio allocation",
            description = "Returns the asset breakdown of a fund's disclosed portfolio."
    )
    @ApiResponse(
            responseCode = "200",
            description = "Fund portfolio allocation retrieved successfully."
    )
    @ApiResponse(
            responseCode = "502",
            description = "Infina returned an error response."
