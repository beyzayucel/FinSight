  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-[18px] shadow-2xl border border-admin-line w-full max-w-md mx-4 p-6">
        <h3 className="font-heading text-lg font-bold text-admin-ink mb-5">Yeni Kullanıcı</h3>

        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <ModalField label="E-posta" value={form.email} onChange={(v) => handleChange('email', v)} placeholder="ornek@infina.com" type="email" />
